...
public class Main 
{
    ...
    private static Administrator admin=new Administrator("admin@mail.com", "adminpass");        // only 1 admin ID
    private static List<TeachingAssistant> TAs=new ArrayList<>();
    ...
    public static void main(String[] args) 
    {
        ...
        Course course1=new Course("CS101", "Intro to CS", 4, "Mon-Wed 10 AM",1,"prof1","P001",5);
        Course course2=new Course("CS102", "Data Structures", 4, "Tue-Thu 2 PM",2,"prof2","P002",5);
        Course course3=new Course("CS201", "Algorithms", 4, "Mon-Wed 1 PM", 8, "prof1", "P001",1);
        Course course4=new Course("CS202", "Operating Systems", 4, "Tue-Thu 10 AM", 2, "prof3", "P003",5);
        Course course5=new Course("CS301", "Database Systems", 2, "Mon-Wed 3 PM", 3, "prof3", "P003",5);
        courses.add(course1);
        courses.add(course2);
        courses.add(course3);
        courses.add(course4);
        ...
        Student student1=new Student("student1@mail.com","pass1","S001",1);
        Student student2=new Student("student2@mail.com","pass2","S002",2);
        Student student3=new Student("student3@mail.com","pass3","S003",3);
        students.add(student1);
        students.add(student2);
        students.add(student3);

        Professor prof1=new Professor("prof1@mail.com","prof1","P001","prof1");
        Professor prof2=new Professor("prof2@mail.com","prof2","P002","prof2");
        Professor prof3=new Professor("prof3@mail.com","prof3","P003","prof3");
        ...
        student2.setGrade(course2,"B");
        student3.setGrade(course4,"C-");
        student3.setGrade(course5,"C");

        TeachingAssistant TA1= new TeachingAssistant("ta1@mail.com","pd1","T001",8,course1); 
        TeachingAssistant TA2= new TeachingAssistant("ta2@mail.com","pd2","T002",8,course2);
        TAs.add(TA1);
        TAs.add(TA2); 
        students.add(TA1);
        students.add(TA2);
        TA1.registerForCourse(course3,courses);
        TA2.registerForCourse(course3,courses);
    ...
    private static void loginStudent(Scanner scanner) throws InvalidLoginException
    {
        ...
        while (loggedIn) 
        {
            ...
            switch (choice) 
            {
                ...
                case 2 ->
                {
                    try
                    {
                        student.registerForCourse(courses);
                    }
                ...
                case 7 -> student.giveFeedback(courses);
                case 8 ->
                {
                    student.logout();
                    loggedIn=false;
    ...
    private static void loginProfessor(Scanner scanner) throws InvalidLoginException
    {
        System.out.print("Enter email: ");
        String email = scanner.nextLine();
        System.out.print("Enter password: ");
    ...
    private static void professorMode(Scanner scanner,Professor professor) 
    {
        ...
        while (loggedIn) 
        {
            ...
            System.out.println("4. View Course Feedbacks");
            System.out.println("5. View TAs");
            ...
            switch (choice) 
            {
                ...
                case 4 -> professor.viewFeedbackForCourses();
                case 5 -> professor.viewTAs(TAs);
                case 6 ->
                {
                    professor.logout();
                    loggedIn = false;
    ...
    private static void loginAdministrator(Scanner scanner) throws InvalidLoginException
    {
        System.out.print("Enter email: ");
        String email = scanner.nextLine();
        System.out.print("Enter password: ");
    ...
    private static void loginTA(Scanner scanner) throws InvalidLoginException
    {
        System.out.print("Enter email: ");
        String email = scanner.nextLine();
        System.out.print("Enter password: ");
    ...
    private static void taMode(Scanner scanner,TeachingAssistant TA) 
    {
        boolean loggedIn = true;
        ...
        while (loggedIn) 
        {
            ...
            switch (choice) 
            {
                case 1 -> TA.viewStudentGrades();
                case 2 -> TA.updateStudentGrade();
                case 3 ->
                {
                    TA.logout();
                    loggedIn=false;
